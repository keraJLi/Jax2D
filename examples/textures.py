...
RJOINT_TEXTURE_16_RGBA = load_texture("rjoint2.png", 16)

FJOINT_TEXTURE_RGBA = load_texture("fjoint2.png", 32)
FJOINT_TEXTURE_16_RGBA = load_texture("fjoint2.png", 16)
...
THRUSTER_TEXTURE_16_RGBA = jnp.rot90(load_texture("thruster6.png", 16), k=3)
